program dirac_exchange_pbe_mu
  BEGIN_DOC
  ! produce the exchange energy given by the relativistic pbe
  END_DOC
   call run_exchange_pbe_mu 
 end

 subroutine run_exchange_pbe_mu
  BEGIN_DOC
 ...
 !Choose Interaction
  ...
  elseif (dirac_interaction == "Coulomb_Gaunt") then
   ...
   open (10, file='exchange_pbe_Z_CG.dat',position ='append')
