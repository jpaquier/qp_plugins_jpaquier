program dirac_ao_basis
  ...
  complex*16 :: two_dirac_aos_grad_array(3,2*dirac_ao_num),large_aos_grad_array(3,large_ao_num),small_aos_grad_array(3,small_ao_num)
...
!enddo
 ...
 print*,"****************************"
 do i = 1, large_ao_num
  print*, i,large_aos_array(i),large_aos_grad_array(1,i),large_aos_grad_array(2,i),large_aos_grad_array(3,i)
 enddo
 print*,"**************"
 do i = 1, small_ao_num
  print*, i,small_aos_array(i),small_aos_grad_array(1,i),small_aos_grad_array(2,i),small_aos_grad_array(3,i)
 enddo 
 print*,'************************************************************'
