...
!call wall_time(wall_1)
 do istate = 1, N_states 
  call zgemm('N','N',2*dirac_ao_num,2*dirac_ao_num,n_points_final_grid,(1.d0,0.d0),dirac_aos_in_r_array,2*dirac_ao_num,dirac_aos_vc_LDA_w(1,1,istate),n_points_final_grid,(0.d0,0.d0),dirac_potential_c_ao_LDA(1,1,istate),2*dirac_ao_num)
  call zgemm('N','N',2*dirac_ao_num,2*dirac_ao_num,n_points_final_grid,(1.d0,0.d0),dirac_aos_in_r_array,2*dirac_ao_num,dirac_aos_vx_LDA_w(1,1,istate),n_points_final_grid,(0.d0,0.d0),dirac_potential_x_ao_LDA(1,1,istate),2*dirac_ao_num)
 enddo
