...
! TODO
  ...
  !Write(31,*) "mu_of_r_for_ints_vector =",mu_of_r
   ...
   write(28,*) r(1),dm(1),dsqrt(2*tr_dm_2(1)),3.0936677262801355d0*(dm(1)**0.3333333333333333d0),3.0936677262801355d0*( dsqrt(2*tr_dm_2(1))**0.3333333333333333d0)
   ...
   write(34,*) r(1), grad_dm_on_top_abs 
  !r(1)+=0.00001d0
   r(1)+=0.0005d0
  !r(1)+=0.001d0
  enddo
