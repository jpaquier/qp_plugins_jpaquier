...
! TODO
  ...
  call dirac_grad_dm_dft_at_r(r,grad_dm,grad_dm_complex)
   ...
   write(31,*) "x",grad_dm_a(1,1)+grad_dm_b(1,1),grad_dm(1,1),grad_dm_complex(1,1)
   write(31,*) "y",grad_dm_a(2,1)+grad_dm_b(2,1),grad_dm(2,1),grad_dm_complex(2,1)
   write(31,*) "z",grad_dm_a(3,1)+grad_dm_b(3,1),grad_dm(3,1),grad_dm_complex(3,1)   
   end
