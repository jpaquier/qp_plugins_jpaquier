 ...
 ! large_ao_ortho_canonical orbital
  ...
  call dirac_ortho_canonical(large_ao_overlap,size(large_ao_overlap,1), large_ao_num,large_ao_ortho_canonical_coef, size(large_ao_ortho_canonical_coef,1), large_ao_ortho_canonical_num)
 END_PROVIDER
