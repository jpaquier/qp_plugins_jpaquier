 BEGIN_PROVIDER[ integer, index_two_e_no_sym_test ]
 BEGIN_DOC
 !more test
 END_DOC
 implicit none
 integer :: i,j,k,l,p,q,r,s,i2
 do i = 1, 5
  do j = 1, 5
   do k = 1, 5
    do l = 1, 5 
     ...
     s = max(j,l)
     q = q+ishft(s*s-s,-1)
     index_two_e_no_sym_test = (p-1)*dirac_ao_num*dirac_ao_num + q
     write(10,*), i,j,k,l
     write(10,*), p,q,r,s,index_two_e_no_sym_test    
     write(10,*),"**************"
    enddo
   enddo
  enddo
 ...
 BEGIN_PROVIDER[integer, quad, (4,4)]
 BEGIN_DOC
 !more test
 END_DOC
 implicit none
 integer :: i1,i2
 !i(1) = quad (1,1), i(4) =quad(1,4), l(4) = quad (4,4)
  do i1 = 1, 10
   quad = 0
...
! l(8) = i(1)
 ...
 !    if (i1 /= i2) then
 !      print *,  i1, i2
 !      print *,  i(ii), j(ii), k(ii), l(ii), dirac_ao_num
